...
/// File hash algorithm type 文件哈希算法类型
...
/**
 Utility for computing hashes of file with high performance and low memory usage. 实用的文件哈希计算工具，具有高性能和低内存使用率。
...
@property (nullable, nonatomic, strong, readonly) NSString *md5String; ///< md5 hash string in lowercase  md5哈希字符串小写
