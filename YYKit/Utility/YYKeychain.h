...
/**
 A wrapper for system keychain API. 系统钥匙串API的封装。
...
///=============================================================================
#warning zll keychain 获取/设置/删除密码
/**
...
typedef NS_ENUM (NSUInteger, YYKeychainErrorCode) {
    YYKeychainErrorUnimplemented = 1, ///< Function or operation not implemented. 功能或操作未实现。
