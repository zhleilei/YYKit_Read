...
/// Create an object to check the reachability of a given host name.创建一个对象以检查给定主机名的可达性。 baidu.com
+ (nullable instancetype)reachabilityWithHostname:(NSString *)hostname;

/// Create an object to check the reachability of a given IP address 创建一个对象以检查给定IP地址的可达性 10.0.10.10
