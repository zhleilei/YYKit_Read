...
/// Specifies how the ruby(红宝石) text and the base text should be aligned(对齐) relative(相对的) to each other.
@property (nonatomic) CTRubyAlignment alignment;

/// Specifies how the ruby text can overhang(悬垂) adjacent(相邻) characters.
@property (nonatomic) CTRubyOverhang overhang;

/// Specifies the size of the annotation(注解) text as a percent of the size of the base text.
...
@property (nullable, nonatomic, copy) NSString *textInterCharacter; // 文字间字符
