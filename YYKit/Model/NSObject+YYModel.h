 ...
 */
#warning zll modelDescription test
...
/**
 ...
 如果您需要在json-> object转换期间创建不同的实例，
  
 使用该方法基于dictionary的自定义类。
...
#warning zll blacklist 设置以及应用场景?
/**
...
/**
 ...
 this method to do additional process. You can also use this method to validate the
 json dictionary.
 如果默认的model-to-json转换不适合您的模型类，请用这种方法要做额外处理.
 您也可以使用此方法来验证json字典。
 @discussion If the model implements this method, it will be called at the end of
