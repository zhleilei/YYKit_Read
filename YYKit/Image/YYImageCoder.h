...
/**
 Dispose method specifies how the area used by the current frame is to be treated(处理过的)
 before rendering the next frame on the canvas.
 
 Dispose方法指定如何处理当前帧使用的区域
 在画布上渲染下一帧之前。
 */
...
/**
 Updates the incremental image with new data. 图片新增数据更新
...
/**
 Wherher the image can be display on screen without additional decoding. 图像是否可以显示在屏幕上而无需其他解码。
 @warning It just a hint(暗示) for your code, change it has no other effect.
 */
